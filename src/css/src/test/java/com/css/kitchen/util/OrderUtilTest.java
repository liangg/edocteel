...
public class OrderUtilTest {
  ...
  public void testJsonObjectToOrder() {
    ...
    assertEquals(order.getType(), Order.FoodType.Hot);
  ...
  public void testOrderJsonArray() {
    ...
    assertEquals(orders.get(0).getType(), Order.FoodType.Hot);
    assertEquals(orders.get(1).getName(), "Sushi dragonroll");
    assertEquals(orders.get(1).getType(), Order.FoodType.Cold);
  }
  ...
  public void testOrderJsonFile() {
    ...
    assertEquals(orders.get(0).getType(), Order.FoodType.Frozen);
    ...
    assertEquals(orders.get(1).getType(), Order.FoodType.Frozen);
    ...
    assertEquals(orders.get(2).getType(), Order.FoodType.Cold);
    ...
    assertEquals(orders.get(3).getType(), Order.FoodType.Cold);
